...
<!-- nav bar-->
	...
	<a href="https://forms.gle/BDJFDfu2m3obyQPY7">
		<div style="border:1px solid black;width:60%;border-radius:15px;float:left;height:70px;margin-left:30px;margin-top:30px">
			<div style="border:0px solid red;width:6%;float:left"><img src="images/casestudies.png" style="padding-top:15px;padding-left:10px"></div>
			<div style="border:0px solid red;width:90%;float:left;margin-top:25px"> <span style="margin-top:15px">QUIZ 1: Introduction to Machine Learning | 15-07-2022
			</div>
		</div>
	</a>
		<a href="https://forms.gle/BDJFDfu2m3obyQPY7">
		<div style="border:1px solid black;width:60%;border-radius:15px;float:left;height:70px;margin-left:30px;margin-top:30px">
			<div style="border:0px solid red;width:6%;float:left"><img src="images/designed.png" style="padding-top:15px;padding-left:10px"></div>
			<div style="border:0px solid red;width:90%;float:left;margin-top:25px"> <span style="margin-top:15px">QUIZ 2: Introduction to DATA science | 31-08-2022
			</div>
		</div>
	</a>
	<a href="https://forms.gle/BDJFDfu2m3obyQPY7">
		<div style="border:1px solid black;width:60%;border-radius:15px;float:left;height:70px;margin-left:30px;margin-top:30px">
			<div style="border:0px solid red;width:6%;float:left"><img src="images/industrysession.png" style="padding-top:15px;padding-left:10px"></div>
			<div style="border:0px solid red;width:90%;float:left;margin-top:25px"> <span style="margin-top:15px">QUIZ 3: Introduction to  Statistics | 3-09-2022
			</div>
		</div>
	</a>
	...
	<a href="https://forms.gle/BDJFDfu2m3obyQPY7">
		<div style="border:1px solid black;width:60%;border-radius:15px;float:left;height:70px;margin-left:30px;margin-top:30px">
			<div style="border:0px solid red;width:6%;float:left"><img src="images/timeinterviews.png" style="padding-top:15px;padding-left:10px"></div>
			<div style="border:0px solid red;width:90%;float:left;margin-top:25px"> <span style="margin-top:15px">QUIZ 4: Excel  | 15-08-2022
			</div>
		</div>
	</a>
	...
	<a href="https://forms.gle/BDJFDfu2m3obyQPY7">
		<div style="border:1px solid black;width:60%;border-radius:15px;float:left;height:70px;margin-left:30px;margin-top:30px">
			<div style="border:0px solid red;width:6%;float:left"><img src="images/highperformancecoaching.png" style="padding-top:15px;padding-left:10px"></div>
			<div style="border:0px solid red;width:90%;float:left;margin-top:25px"> <span style="margin-top:15px">QUIZ 5: Introduction to PHP myadimin  | 15-01-2023
			</div>
		</div>
	</a>
</body>
