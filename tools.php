...
<!-- nav bar-->
	...
	<div  style="border:0px solid red;width:83.6%;height:614px;float:left;background-color:">
		...
		<div style="margin:30px">
			<div style="border-bottom:2px solid grey;text-align:left;font-family:Source Sans Pro;font-size:25px;width:80%;height:70px;margin:10px;"><div style="padding-top:30px;padding-left:20px">Required tools:  </div>
			</div> 
			<br><br><br>
			<a href="https://play.google.com/store/apps/details?id=com.microsoft.office.excel&hl=en_IN&gl=US"><img src="images/excel2.png" height="60px" width="120px" style="margin-top:0px;margin-top:0px"></a>
			<a href="https://www.python.org/downloads/"><img src="images/python.png" height="60px" width="120px" style="margin-left:30px;margin-top:0px"></a>
			<a href="https://numpy.org/"><img src="images/numpy.png" height="60px" width="120px" style="margin-left:30px;margin-top:0px"></a>
			<a href="https://cran.r-project.org/bin/windows/base/"><img src="images/Rlogo.png" height="50px" width="110px" style="margin-left:30px;margin-top:0px"></a>
			<a href="https://pypi.org/project/scipy/"><img src="images/scipy.png" height="60px" width="120px" style="margin-left:30px;margin-top:0px"></a>
			<a href="https://matplotlib.org/"><img src="images/matplotlib.png" height="60px" width="160px" style="margin-left:30px;margin-top:0px"></a><br><br><br><br><br>
			<a href="https://pandas.pydata.org/"><img src="images/pandas.png" height="60px" width="140px" style="margin-left:30px;margin-top:0px"></a>
			<a href="https://www.tensorflow.org/resources/learn-ml?gclid=EAIaIQobChMIiMP2wPPa-QIVWD5gCh1uogDKEAAYASAAEgIrGvD_BwE"><img src="images/tensorflow-logo.png" height="50px" width="250px" style="margin-left:30px;margin-top:0px"></a>
			<a href="https://www.tableau.com/products/desktop/download"><img src="images/Tableau.png" height="50px" width="200px" style="margin-left:30px;margin-top:0px"></a>
			<a href="https://www.mysql.com/downloads/"><img src="images/mysql.png" height="60px" width="120px" style="margin-left:30px;margin-top:0px"></a>
