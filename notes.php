...
<!-- nav bar-->
	...
	<div style="border:0px solid red;width:14%;margin-left:18px;margin-top:14px;float:left">
		<a href="images/bigdata.pdf" download>
		  <img src="images/bigdata.jpg" height="230px" width="160px">
		</a>
		<div style="color:grey;text-decoration:none;tetx-align:center;font-size:20px">Big Data in Practice<br><span style="tetx-align:center;font-size:15px">
		-Bernard Marr<br><span>
		&#9675; 2.34 mb &nbsp;&nbsp; &#9675; 323pages &nbsp;&nbsp; 
		</div>
	</div>
 
	<div style="border:0px solid red;width:14%;margin-left:18px;margin-top:14px;float:left">
		<a href="images/EverybodyLies.pdf" download>
		  <img src="images/everybodylies.jpg" height="230px" width="160px">
		</a>
		<div style="color:grey;text-decoration:none;tetx-align:center;font-size:20px">Everybody Lies: <br><span style="tetx-align:center;font-size:15px">
		-Seth Stephens-Devidowitz<br><span>
		&#9675; 2.86 mb &nbsp;&nbsp; &#9675; 307pages &nbsp;&nbsp; 
		</div>
	</div>

	<div style="border:0px solid red;width:14%;margin-left:18px;margin-top:14px;float:left">
		<a href="images/dataminingandbigdata.pdf" download>
		  <img src="images/knowledgediscovery.jfif" height="230px" width="160px">
		</a>
		<div style="color:grey;text-decoration:none;tetx-align:center;font-size:20px">Big Data analytics and knowledge discovery<br><span style="tetx-align:center;font-size:15px">
		-Springer 2016<br><span>
		&#9675; 44.7 mb &nbsp;&nbsp; &#9675; 565pages &nbsp;&nbsp; 
		</div>
	</div>
	...
	<div style="border:0px solid red;width:14%;margin-left:18px;margin-top:14px;float:left">
		...
		<a href="images/predectivemarketing.pdf" download>
		  <img src="images/prdectivemarketing.jpg" height="230px" width="160px">
		</a>
		<div style="color:grey;text-decoration:none;tetx-align:center;font-size:20px">Prdective Marketing<br><span style="tetx-align:center;font-size:15px">
		-Omer Artun <br><span>
		&#9675; 3.16 mb &nbsp;&nbsp; &#9675; 271pages &nbsp;&nbsp; 
		</div>
	</div>
	...
	<div style="border:0px solid red;width:14%;margin-left:18px;margin-top:14px;float:left">
		<a href="images/datastrategy.pdf" download>
		  <img src="images/datastrategy.jpg" height="230px" width="160px">
		</a>
		<div style="color:grey;text-decoration:none;tetx-align:center;font-size:20px">Data strategy<br><span style="tetx-align:center;font-size:15px">
		-Bernard Marr<br><span>
		&#9675; 1.29 mb &nbsp;&nbsp; &#9675; 299pages &nbsp;&nbsp; 
		</div>
	</div>
