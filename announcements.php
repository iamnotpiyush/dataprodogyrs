...
<!-- nav bar-->
	...
	<div  style="border:0px solid red;width:83.6%;height:614px;float:left;background-color:">
		...
		<div style="border-bottom:2px solid grey;text-align:left;font-family:Source Sans Pro;font-size:25px;width:60%;height:70px;margin:20px;"><div style="padding-top:30px;padding-left:20px">Announcements  </div>
		</div>
			<div style="border-bottom:0px solid grey;text-align:left;font-family:Source Sans Pro;font-size:18px;width:60%;height:70px;margin:20px;color:grey">
