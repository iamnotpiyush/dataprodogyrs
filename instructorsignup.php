...
<div style="color:black;font-family:Papyrus;font-size:45px;margin-top:0px;left;padding-left:130px">dataprodog!</div>
 ...
 <form>
   <div class="form" style="padding-top:0px">      
	  ...
	  <br>
	  <input type="text" class="textfiled"  placeholder="password" name="password" required>
	  <br>
	  <input type="text" class="textfiled" placeholder="email address"name="emailaddress" required>
	  <br>
	  <input type="text" class="textfiled" placeholder="conform password" name="conformpassword" required>
       <br>
	   <a href="index.php">
...
$query="INSERT INTO instructor VALUES('$fn','$ln','$mn','$ea','$pw','$cpw')";
