			...
			<div style="color:black;font-family:Papyrus;font-size:45px;margin-top:240px;left;padding-left:130px">dataprodog!
			 ...
			 <div class="form" style="padding-top:0px">      
				   ...
				   <input type="submit" name="login" value="login "class="btn">
					<div class="forgetpass"><a href="#" class="link" onclick="message()" style="color:#4FB0AE">Forgot password ?</a></div>
					<div class="forgetpassword"><span style="color:grey;">Don't have an account?<a href="signup.php" class="link" style="color:#4FB0AE"> Register</a></div>
...
<?php
	...
	if(isset($_POST['login'])){
		...
		$query ="SELECT * FROM instructor WHERE emailaddress ='$username' && password='$pwd'";
