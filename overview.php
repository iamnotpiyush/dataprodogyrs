...
<!-- nav bar-->
	...
	<div  style="border:0px solid red;width:83.6%;height:614px;float:left;background-color:;margin:px">
		<div style="border:0px solid red;width:60%;height:100px;float:left;margin:23px">
				<div style="font-size:25px;font-family:Source Sans Pro">Requirements<span style="font-size:14px;color:grey;margin-left:50px">
				<li >Introduction to statistics course (either currently taking or already have completed) is recommended but not absolutely necessary
				<li>Access to IBM SPSS Statistical software (strongly recommended)
				</span>
				</div><br>
			<div style="font-size:25px;font-family:Source Sans Pro">Description<span style="font-size:14px;color:grey;;padding-left:50px;"><br>
				<div style="">November, 2019. 
			...
			<br>
				...
				<div style="font-size:25px;font-family:Source Sans Pro">
					Use Tests in SPSS to Correctly Analyze Inferential Statistics<br> <span style="font-size:14px;color:grey;">
					<li>Use the One Sample t Test to Draw Conclusions about a Population
					<li>Understand ANOVA and the Chi Square
					<li>Master Correlation and Regression
					<li>Learn Data Management Techniques
					<li>Understand ANOVA and the Chi Square
					<li>Master Correlation and Regression
					<li>Learn Data Management Techniques
		...
		<div style="border:0px solid red;width:30%;height:100px;float:left;margin-top:30px">
		<img src="images/overview2.jpg">
		</div>
	</div>
