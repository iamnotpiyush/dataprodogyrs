...
<!-- nav bar-->
	...
	<div  style="border:0px solid red;width:83.6%;height:614px;float:left;background-color:">
		<div style="border:0px solid red;width:350px;height:300px;margin-left:400px;margin-top:100px">
			<img src="images/qna.jpg" height="280px" width="300px">
			<div style="text-align:center;font-family:Source Sans Pro;">have a question? <a href="contactus.php" style="text-decoration:none;font-family:Source Sans Pro;color:green"> contact us </a> </div>
		</div>
	</div>
</body>
</html>
